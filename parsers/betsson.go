...
func (p *Betsson) ScrapeTournament(tournamentUrl string) (bool, error) {
	...
	// curl --location --request GET 'https://www.betsson.gr/api/sb/v1/widgets/events-table/v2?maxMarketCount=5&categoryIds=1&regionIds=17&competitionIds=9' \
	...
	req, _ := http.NewRequest("GET", tourUrl, nil)
